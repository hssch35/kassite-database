...
### Struktur der Lautklassen-Cluster
 | Kategorie                 |   Anzahl |   Anteil % |
|---------------------------|----------|------------|
| Liquida+Labiale           |       21 |      22.8% |
| Nasale+Dentale            |       16 |      17.4% |
| Velare+Dentale            |        8 |       8.7% |
| Sibilanten+Labiale        |        5 |       5.4% |
| Liquida+Nasale            |        4 |       4.3% |
| Liquida+Andere            |        4 |       4.3% |
| Sibilanten+Nasale         |        4 |       4.3% |
| Nasale+Andere             |        4 |       4.3% |
| Sibilanten+Sibilanten     |        3 |       3.3% |
| Labiale+Andere            |        3 |       3.3% |
| Nasale+Velare             |        3 |       3.3% |
| Labiale+Sibilanten        |        2 |       2.2% |
| Sibilanten+Dentale        |        2 |       2.2% |
| Dentale+Dentale           |        2 |       2.2% |
| Liquida+Liquida           |        1 |       1.1% |

### Sonoritäts-Profil (Cluster-Tendenz)
 | Kategorie                 |   Anzahl |   Anteil % |
|---------------------------|----------|------------|
| Absteigend                |       64 |      69.6% |
| Plateau                   |       17 |      18.5% |
...
### Top Silbenstrukturen (CV-Muster)
 | Kategorie                 |   Anzahl |   Anteil % |
|---------------------------|----------|------------|
| CVCVCCV                   |       19 |       3.3% |
| CVCVCVCV                  |       15 |       2.6% |
...
### Häufigste Morphem-Wurzeln (Top 15)
 | Kategorie                 |   Anzahl |   Anteil % |
|---------------------------|----------|------------|
| Uz                        |        4 |       0.7% |
| Kilam                     |        3 |       0.5% |
...
### Häufigste Suffixe (Automatisch erkannt)
 | Kategorie                 |   Anzahl |   Anteil % |
|---------------------------|----------|------------|
| -saḫ                      |       61 |      12.8% |
| iyaš                      |       22 |       4.6% |
